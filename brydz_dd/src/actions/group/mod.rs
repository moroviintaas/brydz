...
use brydz_core::karty::hand::{CardSet, StackHandIntervalIterator};
...
pub trait ActionOptimiser: Debug  + Clone + Default{
    //fn group(hand: &StackHand, suit: &Suit) -> SmallVec<[CardPack; CONTRACT_ACTION_SPACE_BOUND]>;
...
/// ```
pub fn are_cards_neighbouring(hand_set: &CardSet, card_1: &Card, card_2: &Card) -> bool{
