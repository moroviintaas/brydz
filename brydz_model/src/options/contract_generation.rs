...
pub struct GenContractOptions {
    #[arg(short = 'g', long = "game-count", help = "Number of game parameters to generate", default_value = "1")]
    pub game_count: u64,
    ...
    #[arg(short = 'l', long = "lower-bound", help = "Minimal contract value", value_parser = clap::value_parser!(u8).range(1..=7), default_value = "1")]
    pub min_contract: u8,
    #[arg(short = 'u', long = "upper-bound", help = "Maximal contract value", value_parser = clap::value_parser!(u8).range(1..=7), default_value = "7")]
    pub max_contract: u8,
    ...
    #[arg(short = 't', long = "trump-limit", help = "Subset of possible trumps", default_value_t = Subtrump::All, rename_all = "snake_case")]
    pub trump_limit: Subtrump,
    #[arg(short = 'f', long = "force-declarer", help = "Force one side to be declarer", default_value_t = ForceDeclarer::DontForce, value_enum)]
